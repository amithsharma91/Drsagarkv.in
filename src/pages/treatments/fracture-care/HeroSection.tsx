export default function FractureTraumaHero() {
  return (
    <section className="relative w-full min-h-[55vh] flex items-center justify-center overflow-hidden bg-secondary-600">
      <div className="absolute inset-0">
        <img
          src="https://readdy.ai/api/search-image?query=Orthopedic%20surgeon%20examining%20arm%20cast%20and%20fracture%20recovery%2C%20modern%20hospital%20environment%2C%20realistic%20medical%20photography%2C%2016:9&width=1600&height=960&seq=phase4-fracture-care-hero&orientation=landscape"
          alt="Fracture Care - Dr. Sagar K V"
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[14%] left-[10%] w-38 h-38 rounded-full border border-white/5 animate-spin-slow" style={{ animationDuration: '36s' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 py-20 md:py-24 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 mb-6 reveal">
          <i className="ri-shield-line text-teal-400 text-sm"></i>
          <span className="text-white/80 text-xs font-medium tracking-wide">Fracture Care</span>
        </div>
        ...
        <p className="text-white/55 text-base md:text-lg max-w-2xl mx-auto mb-6 reveal" style={{ transitionDelay: '200ms' }}>
          From simple plaster casting to complex surgical fixation — comprehensive fracture and trauma care with a focus on rapid, complete recovery.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 mb-8 reveal" style={{ transitionDelay: '300ms' }}>
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-teal-300">24/7</span>
            <span className="text-white/45 text-xs">Emergency Care</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-teal-300">4000+</span>
            <span className="text-white/45 text-xs">Fractures Treated</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
