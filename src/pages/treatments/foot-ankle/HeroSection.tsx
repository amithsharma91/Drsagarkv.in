export default function FootAnkleHero() {
  return (
    <section className="relative w-full min-h-[55vh] flex items-center justify-center overflow-hidden bg-secondary-600">
      <div className="absolute inset-0">
        <img
          src="https://readdy.ai/api/search-image?query=Orthopedic%20surgeon%20examining%20patient%20foot%20and%20ankle%20condition%2C%20modern%20consultation%20room%2C%20realistic%20healthcare%20photography%2C%2016:9&width=1600&height=960&seq=phase4-foot-ankle-hero&orientation=landscape"
          alt="Foot & Ankle Disorders - Dr. Sagar K V"
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[12%] right-[12%] w-38 h-38 rounded-full border border-white/5 animate-spin-slow" style={{ animationDuration: '31s' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 py-20 md:py-24 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 mb-6 reveal">
          <i className="ri-footprint-line text-teal-400 text-sm"></i>
          <span className="text-white/80 text-xs font-medium tracking-wide">Foot & Ankle Care</span>
        </div>
        ...
        <h1 className="font-heading font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-tight mb-4 reveal" style={{ transitionDelay: '100ms' }}>
          Foot & Ankle{' '}
          <span className="text-teal-400">Disorders</span>
        </h1>

        <p className="text-white/55 text-base md:text-lg max-w-2xl mx-auto mb-6 reveal" style={{ transitionDelay: '200ms' }}>
          From heel pain to complex ankle instability — the full range of foot and ankle conditions affecting mobility and quality of life.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 mb-8 reveal" style={{ transitionDelay: '300ms' }}>
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-teal-300">90%</span>
            <span className="text-white/45 text-xs">Non-Surgical</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-teal-300">2000+</span>
            <span className="text-white/45 text-xs">Patients Treated</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-teal-300">15+</span>
