export default function SportsInjuryHero() {
  return (
    <section className="relative w-full min-h-[55vh] flex items-center justify-center overflow-hidden bg-secondary-600">
      <div className="absolute inset-0">
        <img
          src="https://readdy.ai/api/search-image?query=Sports%20athlete%20consulting%20orthopedic%20surgeon%20after%20injury%2C%20modern%20sports%20medicine%20clinic%2C%20recovery%20planning%2C%20realistic%20medical%20photography%2C%2016:9&width=1600&height=960&seq=phase4-sports-injury-hero&orientation=landscape"
          alt="Sports Injury Treatment - Dr. Sagar K V"
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[15%] right-[12%] w-40 h-40 rounded-full border border-white/5 animate-spin-slow" style={{ animationDuration: '26s' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 py-20 md:py-24 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 mb-6 reveal">
          <i className="ri-run-line text-rose-400 text-sm"></i>
          <span className="text-white/80 text-xs font-medium tracking-wide">Sports Injury Treatment</span>
        </div>
        ...
        <p className="text-white/55 text-base md:text-lg max-w-2xl mx-auto mb-6 reveal" style={{ transitionDelay: '200ms' }}>
          From weekend warriors to professional athletes — specialized sports injury care designed to get you back to peak performance safely and quickly.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 mb-8 reveal" style={{ transitionDelay: '300ms' }}>
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-rose-300">95%</span>
            <span className="text-white/45 text-xs">Return to Sport</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-rose-300">2000+</span>
            <span className="text-white/45 text-xs">Athletes Treated</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-rose-300">15+</span>
