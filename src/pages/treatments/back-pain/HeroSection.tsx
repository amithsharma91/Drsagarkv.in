export default function BackPainHero() {
  return (
    <section className="relative w-full min-h-[55vh] flex items-center justify-center overflow-hidden bg-secondary-600">
      <div className="absolute inset-0">
        <img
          src="https://readdy.ai/api/search-image?query=Orthopedic%20doctor%20reviewing%20spine%20MRI%20scan%20with%20patient%2C%20modern%20consultation%20room%2C%20advanced%20spinal%20treatment%20discussion%2C%20realistic%20healthcare%20photography%2C%2016:9&width=1600&height=960&seq=phase4-back-pain-hero&orientation=landscape"
          alt="Back Pain Treatment - Dr. Sagar K V"
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[18%] left-[8%] w-44 h-44 rounded-full border border-white/5 animate-spin-slow" style={{ animationDuration: '32s' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 py-20 md:py-24 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 mb-6 reveal">
          <i className="ri-body-scan-line text-emerald-400 text-sm"></i>
          <span className="text-white/80 text-xs font-medium tracking-wide">Back Pain Treatment</span>
        </div>
        ...
        <p className="text-white/55 text-base md:text-lg max-w-2xl mx-auto mb-6 reveal" style={{ transitionDelay: '200ms' }}>
          Back pain shouldn't control your days. Accurate diagnosis and effective treatment for spinal conditions — often without surgery.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 mb-8 reveal" style={{ transitionDelay: '300ms' }}>
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-emerald-300">90%</span>
            <span className="text-white/45 text-xs">Treated Without Surgery</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-emerald-300">5000+</span>
            <span className="text-white/45 text-xs">Back Pain Patients</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-emerald-300">15+</span>
