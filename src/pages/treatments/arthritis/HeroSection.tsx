export default function ArthritisHero() {
  return (
    <section className="relative w-full min-h-[55vh] flex items-center justify-center overflow-hidden bg-secondary-600">
      <div className="absolute inset-0">
        <img
          src="https://readdy.ai/api/search-image?query=Senior%20patient%20discussing%20arthritis%20treatment%20with%20orthopedic%20specialist%2C%20warm%20consultation%20environment%2C%20realistic%20healthcare%20photography%2C%2016:9&width=1600&height=960&seq=phase4-arthritis-hero&orientation=landscape"
          alt="Arthritis Treatment - Dr. Sagar K V"
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[20%] right-[10%] w-36 h-36 rounded-full border border-white/5 animate-spin-slow" style={{ animationDuration: '34s' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 py-20 md:py-24 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 mb-6 reveal">
          <i className="ri-hand-heart-line text-violet-400 text-sm"></i>
          <span className="text-white/80 text-xs font-medium tracking-wide">Arthritis Treatment</span>
        </div>
        ...
        <h1 className="font-heading font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-tight mb-4 reveal" style={{ transitionDelay: '100ms' }}>
          Arthritis{' '}
          <span className="text-violet-400">Treatment</span>
        </h1>

        <p className="text-white/55 text-base md:text-lg max-w-2xl mx-auto mb-6 reveal" style={{ transitionDelay: '200ms' }}>
          A comprehensive approach to arthritis management — from lifestyle changes and medication to advanced joint replacement when needed.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 mb-8 reveal" style={{ transitionDelay: '300ms' }}>
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-violet-300">85%</span>
            <span className="text-white/45 text-xs">Managed Without Surgery</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-violet-300">5000+</span>
            <span className="text-white/45 text-xs">Arthritis Patients</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-violet-300">15+</span>
