export default function JointReplacementHero() {
  return (
    <section className="relative w-full min-h-[55vh] flex items-center justify-center overflow-hidden bg-secondary-600">
      <div className="absolute inset-0">
        <img
          src="https://readdy.ai/api/search-image?query=Orthopedic%20surgeon%20explaining%20knee%20implant%20model%20to%20patient%2C%20joint%20replacement%20consultation%2C%20premium%20hospital%20environment%2C%20realistic%20medical%20photography%2C%20website%20hero%20image%2C%2016:9&width=1600&height=960&seq=phase4-joint-replace-hero&orientation=landscape"
          alt="Joint Replacement Surgery - Dr. Sagar K V"
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[15%] right-[8%] w-48 h-48 rounded-full border border-white/5 animate-spin-slow" style={{ animationDuration: '30s' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 py-20 md:py-24 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 mb-6 reveal">
          <i className="ri-surgical-mask-line text-accent-400 text-sm"></i>
          <span className="text-white/80 text-xs font-medium tracking-wide">Joint Replacement Surgery</span>
        </div>
        ...
        <h1 className="font-heading font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-tight mb-4 reveal" style={{ transitionDelay: '100ms' }}>
          Joint Replacement{' '}
          <span className="text-accent-400">Surgery</span>
        </h1>

        <p className="text-white/55 text-base md:text-lg max-w-2xl mx-auto mb-6 reveal" style={{ transitionDelay: '200ms' }}>
          Minimally invasive knee, hip, and shoulder replacement using the latest implant technology for life-changing outcomes.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 mb-8 reveal" style={{ transitionDelay: '300ms' }}>
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-accent-300">3000+</span>
            <span className="text-white/45 text-xs">Replacements</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-accent-300">&lt;24h</span>
            <span className="text-white/45 text-xs">First Walk</span>
          </div>
          <div className="w-px h-10 bg-white/10" />
          <div className="text-center">
            <span className="block font-heading font-bold text-3xl text-accent-300">98%</span>
